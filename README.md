...
[http://download.tensorflow.org/data/speech_commands_v0.01.tar.gz](http://download.tensorflow.org/data/speech_commands_v0.01.tar.gz), however this copy has been download from IBM Developer Data Asset Exchange for Tensorflow Speech Commands.
Homepage: https://developer.ibm.com/exchanges/data/all/tensorflow-speech-command/
Download Link: https://dax-assets-dev.s3.us-south.cloud-object-storage.appdomain.cloud/dax-tensorflow-speech-commands/1.0.0/tensorflow-speech-commands.tar.gz
